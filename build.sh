...
case $1 in
     x5emmc)
         ...
         rm -rf files
         cp ikt_files/x5/x5.config .config
         cp ikt_files/x5/files/ . -rf
         ...
         make V=s $2
         cp bin/targets/ipq60xx/generic/x5-21.02-v1.0-ipq60xx-generic-ikt_x5-squashfs-nand-sysupgrade.bin firm/$btime-x5emmc.bin
         cp bin/targets/ipq60xx/generic/x5-21.02-v1.0-ipq60xx-generic-ikt_x5-squashfs-nand-factory.ubi  firm/$btime-x5emmc.ubi
      ;;
       x5)
         if [ "$lastbuild" = "ipq60xx" ];then
            echo "last build target is also ipq60xx"
         ...
         make V=s $2
         cp bin/targets/ipq60xx/generic/x5-21.02-v1.0-ipq60xx-generic-ikt_x5-squashfs-nand-sysupgrade.bin firm/$btime-x5.bin
         cp bin/targets/ipq60xx/generic/x5-21.02-v1.0-ipq60xx-generic-ikt_x5-squashfs-nand-factory.ubi  firm/$btime-x5.ubi
      ;;
      x5sw7203)
         if [ "$lastbuild" = "ipq60xx" ];then
            echo "last build target is also ipq60xx"
         ...
         echo "ipq60xx" > lastbuild   
         rm -rf files
         cp ikt_files/x5/x5.sw7203.config .config
         cp ikt_files/x5/files/ . -rf
         make package/base-files/clean V=s
         make package/link4all/lvglipq_x8/clean V=s
         cp logo/logo_linux_clut224.ppm.5g build_dir/target-aarch64_cortex-a53_musl/linux-ipq60xx_generic/linux-5.4.164/drivers/video/logo/logo_linux_clut224.ppm
         ...
         make V=s $2
         cp bin/targets/ipq60xx/generic/x5-21.02-v1.0-ipq60xx-generic-ikt_x5-squashfs-nand-sysupgrade.bin firm/$btime-x5sw7203.bin
         cp bin/targets/ipq60xx/generic/x5-21.02-v1.0-ipq60xx-generic-ikt_x5-squashfs-nand-factory.ubi  firm/$btime-x5sw7203.ubi
      ;;
      x5sw7203emmc)
         if [ "$lastbuild" = "ipq60xx" ];then
            echo "last build target is also ipq60xx"
         ...
         make V=s $2
         cp bin/targets/ipq60xx/generic/x5-21.02-v1.0-ipq60xx-generic-ikt_x5-squashfs-nand-sysupgrade.bin firm/$btime-x5sw7203emmc.bin
         cp bin/targets/ipq60xx/generic/x5-21.02-v1.0-ipq60xx-generic-ikt_x5-squashfs-nand-factory.ubi  firm/$btime-x5sw7203emmc.ubi
      ;;
      x511)
         if [ "$lastbuild" = "ipq60xx" ];then
            echo "last build target is also ipq60xx"
         ...
         echo "ipq60xx" > lastbuild   
         rm -rf files
         cp ikt_files/x511/x511.config .config
         cp ikt_files/x511/files/ . -rf
         make package/base-files/clean V=s
         #cp logo/logo_linux_clut224.ppm.5g build_dir/target-aarch64_cortex-a53_musl/linux-ipq60xx_generic/linux-5.4.164/drivers/video/logo/logo_linux_clut224.ppm
         make V=s $2
         cp bin/targets/ipq60xx/generic/x511-21.02-v1.0-ipq60xx-generic-ikt_x511-squashfs-nand-factory.ubi firm/$btime-x511.bin
      ;;
      q60)
         if [ "$lastbuild" = "ipq60xx" ];then
            echo "last build target is also ipq60xx"
         ...
         echo "ipq60xx" > lastbuild   
         rm -rf files
         cp ikt_files/q60/q60.config .config
         cp ikt_files/q60/files/ . -rf
         make package/base-files/clean V=s
         #cp logo/logo_linux_clut224.ppm.5g build_dir/target-aarch64_cortex-a53_musl/linux-ipq60xx_generic/linux-5.4.164/drivers/video/logo/logo_linux_clut224.ppm
         make V=s $2
         cp bin/targets/ipq60xx/generic/q60-21.02-v1.0-ipq60xx-generic-ikt_q60-squashfs-nand-factory.ubi firm/$btime-q60.bin
      ;;
      x8)
         if [ "$lastbuild" = "ipq60xx" ];then
            echo "last build target is also ipq60xx"
         ...
         echo "ipq60xx" > lastbuild   
         rm -rf files
         cp ikt_files/x8/x8.config .config
         cp ikt_files/x8/files/ . -rf
         make package/base-files/clean V=s
         ...
         make V=s $2
         cp bin/targets/ipq60xx/generic/x8-21.02-v1.0-ipq60xx-generic-ikt_x8-squashfs-nand-factory.ubi firm/$btime-x8.ubi
         cp bin/targets/ipq60xx/generic/x8-21.02-v1.0-ipq60xx-generic-ikt_x8-squashfs-nand-sysupgrade.bin firm/$btime-x8.bin
      ;;
      x2)
         if [ "$lastbuild" = "ipq60xx" ];then
            rm -rf package/kernel/mac80211
         ...
         if [ "$2" = "bond" ];then
            cp ikt_files/x2/x2.bond.config .config
            cp ikt_files/x2/manage1.bond.asp ikt_files/x2/files/www/manage1.asp
         elif [ "$2" = "mwan3" ];then
            cp ikt_files/x2/x2.mwan3.config .config
            cp ikt_files/x2/manage1.mwan3.asp ikt_files/x2/files/www/manage1.asp
         elif [ "$2" = "trojan" ];then
            cp ikt_files/x2/x2.trojan.config .config
            cp ikt_files/x2/manage1.bond.asp ikt_files/x2/files/www/manage1.asp
         elif [ "$2" = "bond_mwan3" ];then
            cp ikt_files/x2/x2.bond_mwan3.config .config
            cp ikt_files/x2/manage1.bond.asp ikt_files/x2/files/www/manage1.asp
         else
         ...
         rm -rf files
         cp ikt_files/x2/files/ . -rf
         make package/base-files/clean V=s
         make V=s $3
         
         if [ "$2" = "bond" ];then
            cp bin/targets/ath79/generic/x2-21.02-v1.0-ath79-generic-ikt_x2-squashfs-sysupgrade.bin firm/$btime-x2.bond.bin
         elif [ "$2" = "mwan3" ];then
            cp bin/targets/ath79/generic/x2-21.02-v1.0-ath79-generic-ikt_x2-squashfs-sysupgrade.bin firm/$btime-x2.mwan3.bin
         elif [ "$2" = "trojan" ];then
            cp bin/targets/ath79/generic/x2-21.02-v1.0-ath79-generic-ikt_x2-squashfs-sysupgrade.bin firm/$btime-x2.trojan.bin
         elif [ "$2" = "bond_mwan3" ];then
            cp bin/targets/ath79/generic/x2-21.02-v1.0-ath79-generic-ikt_x2-squashfs-sysupgrade.bin firm/$btime-x2.bond_mwan3.bin
         else
            echo "please input bond or mwan3"
            exit 1
         fi
      ...
      x2_zwpy)
         ...
         cp ikt_files/x2/zwpy.config .config
         rm -rf files
         cp ikt_files/x2/files/ . -rf
         cp ikt_files/x2/zwpy/* files -rf
         make package/base-files/clean V=s
         make V=s $2
         cp bin/targets/ath79/generic/t421-21.02-v1.0-ath79-generic-ikt_x2-squashfs-sysupgrade.bin firm/$btime-x2_zwpy.bin
         ;;
      x4)
         if [ "$lastbuild" = "ipq60xx" ];then
            rm -rf package/kernel/mac80211
         ...
         rm -rf files
         cp ikt_files/x4/x4.config .config
         cp ikt_files/x4/files/ . -rf
         make package/base-files/clean V=s
      ...
      x4_aodun)
         ...
         cp ikt_files/x4/x4.config .config
         cp ikt_files/x4/files/ . -rf
         cp ikt_files/x4/aodun/* files/ -rf
         make package/base-files/clean V=s
      ...
      x4_zhongxing)
         ...
         cp ikt_files/x4/x4.config .config
         cp ikt_files/x4/files/ . -rf
         cp ikt_files/x4/zhongxing/* files/ -rf
         make package/base-files/clean V=s
      ...
      ;;
       m21ax)
         ...
         rm -rf files
         cp ikt_files/m21ax/m21ax.config .config
         cp ikt_files/m21ax/files/ . -rf
         make package/base-files/clean V=s
         make V=s $2
         cp bin/targets/ramips/mt7621/openwrt-ramips-mt7621-ikt_m21ax-squashfs-sysupgrade.bin firm/$btime-m21ax.bin
      ;;
     *)
